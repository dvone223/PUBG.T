 ...
 "cells": [
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      " * Running on http://0.0.0.0:5898/ (Press CTRL+C to quit)\n",
      "192.168.35.203 - - [03/Aug/2020 22:36:39] \"\u001b[37mGET / HTTP/1.1\u001b[0m\" 200 -\n",
      "192.168.35.203 - - [03/Aug/2020 22:36:39] \"\u001b[33mGET /favicon.ico HTTP/1.1\u001b[0m\" 404 -\n",
      "192.168.35.203 - - [03/Aug/2020 22:37:13] \"\u001b[37mGET / HTTP/1.1\u001b[0m\" 200 -\n",
      "192.168.35.203 - - [03/Aug/2020 22:37:47] \"\u001b[37mPOST /boubtIdSearch HTTP/1.1\u001b[0m\" 200 -\n"
     ]
    }
   ],
   "source": [
    ...
    "        setattr(mod,col,[])\n",
    "    \n",
    "    global teamId,isGame,match_date,match_id,_D,_T,c_name,c_accountId,c_health,pk_killer,pk_victim,\\\n",
    "    pk_victim_accountId,td_attacker,td_victim,td_victim_acouuntId,c_loc_x,c_loc_y,c_loc_z\n",
    "\n",
    ...
    "        try:\n",
    "            data = []\n",
    "            x1, y1, z1, teamId1, isGame,pk_killer,pk_victim,td_attacker,td_victim= time_df.loc[time_df['c_name']==boubtId]\\\n",
    "                [['c_loc_x','c_loc_y','c_loc_z','teamId', 'isGame','pk_killer','pk_victim','td_attacker','td_victim']].iloc[0]\n",
    "            for name in c_names:\n",
    "                if boubtId != name:\n",
